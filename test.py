...
if __name__ == '__main__':
    ...
    for i, data in enumerate(dataset):
        ...
        save_images(webpage, visuals, img_path, predicted_label, true_label)
    #acc = calculate_acc(predicted_label, true_label)
    #sen = calculate_sensitivity(predicted_label, true_label)
    #spe = calculate_specificity(predicted_label, true_label)
    #prec = calculate_precision(predicted_label, true_label)
